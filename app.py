...
from payment_strategy import CreditCardStrategy, PayPalStrategy, BankTransferStrategy
from db_connection import get_central_account, initialize_dummy_accounts
...
if 'booking_id' not in st.session_state:
    st.session_state.booking_id = str(uuid.uuid4())[:8]
if 'amount' not in st.session_state:
    st.session_state.amount = 100.00
